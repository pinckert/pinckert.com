'use strict';
// Requires: https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js

//-----------------------------------------------------------------------
//
//  jqCalendar.js                      Copyright 2016 Dean William Pinckert
//
...
function calendar(parent, name, onMonthChange, onClick, onHover)
{
	...
	console.log("Constructor: " + this.current);
...
calendar.prototype.buildTable=function()
{
   ...
   for (var i=0; i<6;i++)  // max # of rows is 6
   {
