...
//		window.location.href = "http://www.pinckert.com/cgi-bin/dir.py";
	...
	var goBlog=function (context) {
		console.log("Changing page to \"Blog\"");
	};
	
	var goCode=function (context) {
		console.log("Changing page to \"Code\"");
		clearContent(content);
	};

	var goPics=function (context) {
		console.log("Changing page to \"Pics\"");
	};

	var goDBDump = function(context) {
...
//
	...
	var goHobbies=function(event, context) {
		console.dir(context);
		console.dir(event);
		console.log("Changing page to \"Hobbies\"");
		var content = document.getElementById("content");
		// save context
		var currentState = "?page="+context.pageID;
		console.log(currentState);
		history.pushState(currentState, null, null); 
		console.log("Push page: " + context.pageID);

		clearContent(content);
		content.innerHTML ='<object name="pool" type="text/html" width="3000" height="700" data=' + context.url + '</object>';
		event.stopPropagation();
	};

	var goHome=function(context) {
		console.dir(context);
